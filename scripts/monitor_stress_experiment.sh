...
while true; do
    ...
    kubectl get pods -o wide | grep -E "(jitter-|stress-|iperf3-)" | while read line; do
    ...
    kubectl top pods 2>/dev/null | grep -E "(jitter-|stress-|iperf3-)" || echo "No stress pods running"
